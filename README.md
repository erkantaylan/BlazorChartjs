...
- [Styling](https://github.com/erkantaylan/BlazorChartjs/blob/main/docs/styling.md) — legend label styling, line dataset styling (dashes, gaps, point colours, step modes) and the axis border
